...
const styles = {
  ...
  category: { position: 'absolute', top: 10, left: 10, background: 'rgba(26,18,8,0.75)', color: '#fff', fontSize: 11, padding: '3px 10px', borderRadius: 20, fontWeight: 500, backdropFilter: 'blur(4px)' },
