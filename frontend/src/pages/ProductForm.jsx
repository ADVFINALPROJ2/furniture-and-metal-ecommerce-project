  ...
  useEffect(() => {
    ...
    if (isEdit) {
      axios.get(`/api/products/${id}`).then(res => {
        ...
        if (p.image_url) setPreview(`http://localhost:5000${p.image_url}`);
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea name="description" placeholder="Describe your product — material, dimensions, customization options..." value={form.description} onChange={handleChange} rows={4} style={{ resize: 'vertical' }} />
          </div>
          <div className="form-group">
...
const styles = {
  ...
  uploadArea: { border: '2px dashed #E8DDD4', borderRadius: 12, cursor: 'pointer', overflow: 'hidden', minHeight: 160, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#FAF7F4', transition: 'border-color 0.2s' },
