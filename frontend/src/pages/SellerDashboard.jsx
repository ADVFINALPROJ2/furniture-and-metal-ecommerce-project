  ...
  const fetchAll = async () => {
    ...
    try {
      const [pRes, oRes] = await Promise.all([
        axios.get('/api/products/seller/mine'),
                ...
                {products.map(p => (
                  <div key={p.id} className="card" style={styles.productRow}>
                    <div style={styles.productImg}>
                      <img src={p.image_url ? `http://localhost:5000${p.image_url}` : 'https://via.placeholder.com/60'} alt={p.name} style={styles.thumb} />
                    </div>
                ...
                {orders.map(o => (
                  <div key={o.id} className="card" style={styles.orderCard}>
                    <div style={styles.orderLeft}>
                      <img src={o.image_url ? `http://localhost:5000${o.image_url}` : 'https://via.placeholder.com/56'} alt="" style={styles.orderThumb} />
                      <div>
